// this function take a srt file text content and return an object url in vtt format
export function srt2vtt(srtText: string): string {
    // remove dos newlines
    let srt = srtText.replace(/\r+/g, '');
